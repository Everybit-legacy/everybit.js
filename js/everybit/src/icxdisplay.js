        ...
        return (
            <div style={{width: '100%', height: '100%'}}>
                ...
                <div className="contentWindow">
                    {polyglot.t("pass.new")}
                    <br />
                    <textarea spellCheck="false" className={textClass} autoCorrect="off" autoCapitalize="off" ref="passphrase" style={{width: '50%', height: '20%'}} onKeyDown={this.handleKeyDown} onChange={this.handleRecheckPassphrase}/>{' '}<ICXCheckmark show={puffworldprops.ICX.newUser.passphraseStatus} />{' '}<i className={cbClass} onClick={this.togglePassphraseView} ></i>
                    <br />
                    <br />
