...
var ICXWorld = React.createClass({
    render: function () {
        ...
        ICX.screens = [
            ...
            {position: 0, name: 'convo', button: false, color: 'rgba('+c7+', '+op4+')', icon: 'fa-home', fullText: 'Conversation View', component: ICXTableView, backgroundColor: 'rgba('+c6+', '+op2+')', styles: {padding: 0}},
