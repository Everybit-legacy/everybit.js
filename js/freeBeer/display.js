        ...
        if(mode == 'arrows') {
            ...
            var arrowList = (
                React.DOM.svg( {width:screenwidth, height:screenheight, style:{position:'absolute', top:'0px', left:'0px'}}, 
                    React.DOM.defs( {dangerouslySetInnerHTML:{__html: '<marker id="triangle" viewBox="0 0 10 10" refX="0" refY="5" markerUnits="strokeWidth" markerWidth="4" markerHeight="3" orient="auto"><path d="M 0 0 L 10 5 L 0 10 z" /></marker>'}} ),
...
var Arrow = React.createClass({displayName: 'Arrow',
    ...
    render: function() {
        ...
        var result = (
            React.DOM.line( {x1:this.props.x1, y1:this.props.y1, x2:this.props.x2, y2:this.props.y2, stroke:this.props.stroke, strokeWidth:"5"}
