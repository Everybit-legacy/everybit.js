...
var PuffReplyFormExp = React.createClass({
    ...
    render: function() {
        ...
        var sendToField = (
            <div>
                <span style={sendToSpanStyle}>Send to user: </span><input style={sendToInputStyle} type="text" name="usernames" ref="usernames" value={usernames} onChange={this.handleChangeUsernames}></input>
            </div>
        );
        ...
        var sendButton = (
            <a href="#" style={sendStyle}    onClick={this.handleSubmit}><i className="fa fa-paper-plane"></i> Send as {author}</a>
        );
        ...
        return (
            <div id="replyForm" style={formStyle}>
                <div id="replyFormBox" style={boxStyle}>
                    {sendToField}
                    {typeOption}{privacyOption}<br />
                    {contentField}<br/>
